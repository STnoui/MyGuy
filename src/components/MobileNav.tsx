  ...
  return (
    <div className="md:hidden">
      <motion.div
        ...
        className="fixed top-4 left-4 z-50 overflow-hidden bg-background/25 backdrop-blur-lg border border-neutral-200 dark:border-white/10 shadow-2xl"
      >
        <button
            ...
            >
              {navItems.map((item) => (
                ...
                >
                  <Button
                    variant="ghost"
                    className="w-full justify-start text-md py-3 rounded-md hover:bg-background/35 hover:backdrop-blur-xl"
